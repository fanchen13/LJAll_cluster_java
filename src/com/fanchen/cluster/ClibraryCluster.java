package com.fanchen.cluster;

import com.fanchen.fileutil.OSinfo;
...
import com.sun.jna.Native;
	...
	public interface ClibraryCluster extends Library {
		 ...
		 */
		boolean CLUS_Init(String sDefaultPath, String sLicenseCode, int encode);
		 ...
		 */
		boolean CLUS_SetParameter(int nMaxClus, int nMaxDoc);
		 ...
		 */
		boolean CLUS_AddContent(String sText, String sSignature);
		 ...
		 * 备注：在进程中此函数可以在打印结果之前执行多次
		 */
		boolean CLUS_AddFile(String sFileName, String sSignature);
		 ...
		 * @return true - 成功；false - 失败
		 */
		boolean CLUS_GetLatestResult(String sXmlFileName);
