...
public class ClusterTest {
	...
	public void testCluster0(){
		...
		ClibraryCluster.Instance.CLUS_GetLatestResult("test/ClusterResultByFile.xml");
	...
	public void testCluster1(){
		...
		ClibraryCluster.Instance.CLUS_GetLatestResult("test/ClusterResultByContent.xml");
		ClibraryCluster.Instance.CLUS_Exit();
